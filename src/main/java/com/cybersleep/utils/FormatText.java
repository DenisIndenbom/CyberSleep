...
public class FormatText
{
    ...
    public String format(String text, String replaceable, String replacement)
    {
        if (text == null) return "";

        return this.format(text).replace(replaceable, replacement);
    }
}
